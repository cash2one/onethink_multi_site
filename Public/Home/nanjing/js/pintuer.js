$(function(){
	...
	if($.browser.msie) 
	{
		if(parseInt($.browser.version)<8){location.href="http://www.sdcms.cn/ie.html"}
	} 
	...
	$nav.find("li").hover(function(){
		...
		if(index!=li_index){$nav.find("li").eq(li_index).removeClass("current");}
		$navcur.stop().animate({left:leftW,width:currentW},300);
