 ...
 * 后台内容控制器
 */
class ArticleController extends \Admin\Controller\ProfileController {
     ...
     * @param integer $group_id 分组id
     */
    protected function getDocumentList($cate_id,$model_id=null,$position=null,$field=true,$group_id=null){
        /* 查询条件初始化 */
        $map = array();
        if(isset($_GET['title'])){
    ...
    public function add(){
        ...
        $this->display('Profile/Article/add');
    }
