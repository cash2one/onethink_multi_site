...
return array(
    ...
    */  
    '_ERROR_404_'            => '页面不存在',
    '_CATEGORY_NOT_EXIST_'   => '分类不存在',
    '_WEB_SERVER_CLOSE_'     => '站点已经关闭，请稍后访问~',
    '_DOC_ID_ERROR_'         => '文档ID错误！',
    '_DOC_CATE_REQUIRED'     => '没有指定文档分类！',
    '_CATEGORY_FORBIDDEN_'   => '该分类禁止显示！',
    '_CATEGORY_NOT_EXIST_OR_FORBIDDEN_'   => '分类不存在或被禁用！',
    '_CONTENT_NOT_EXIST'    => '没有添加内容!',
);
